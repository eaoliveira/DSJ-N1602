...
public class EnviaEmail {
  public static void main(String[] args) {
    try {
      ...
      message.setContent(
        JOptionPane.showInputDialog(null, "Informe o texto do e-mail!"), 
        "text/plain");

      // Define o(s) remetente(s)
      InternetAddress[] remetentes = {
        new InternetAddress(
          JOptionPane.showInputDialog(null, "Informe o Remetente!"))
      };
      ...
      java.util.List<InternetAddress> destinatarios = 
        new java.util.ArrayList<InternetAddress>();
