...
public class Ex09 extends JPanel {
		...
		btOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				try {
					...
					JOptionPane.showMessageDialog(getParent(), String
							.format("O resultado da divisão de %d por %d é %f", num1, num2,
					...
					JOptionPane.showMessageDialog(null, "Nao informe ZEROS");
				}
	...
	public static void main(String[] args) {
		...
		tela.getContentPane().add(new Ex09(), "Center");
		tela.pack();
