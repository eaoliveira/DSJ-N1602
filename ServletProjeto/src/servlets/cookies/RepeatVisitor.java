...
/**
 * Servlet that says "Welcome aboard" to first-time visitors and "Welcome back"
 * to repeat visitors. Also see RepeatVisitor2 for variation that uses cookie
 * utilities from later in this chapter.
 * <P>
