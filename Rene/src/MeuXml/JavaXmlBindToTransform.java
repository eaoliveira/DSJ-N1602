...
public class JavaXmlBindToTransform {
  public static void main(String[] args) {
    try {
      URL xml = Cadastro.class.getResource("CadastroClientes.xml");
      URL xsl = Cliente.class.getResource("CadastroClientes.xsl");

      JAXBContext ctx = JAXBContext.newInstance(Cadastro.class);
      Unmarshaller u = ctx.createUnmarshaller();
      Cadastro pessoas = (Cadastro)u.unmarshal(xml);
